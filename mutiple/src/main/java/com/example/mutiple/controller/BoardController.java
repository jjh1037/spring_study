...
public class BoardController {
    ...
    public String getBoardList(@RequestParam String configCode, Model model,
        ...
        String searchQuery = boardService.getSearch(searchType, words); // 전체 개수 카운트 -> key id 값이 아닌 순서대로 번호를 매김
...
//      답변형 게시판 처리를 위한 부분
    ...
    public ResponseEntity<Resource> getDownload(@RequestParam String configCode,
    ...
    public String getBoardReply(@RequestParam("files") List<MultipartFile> files,
                                @ModelAttribute BoardDto boardDto, Model model) throws IOException {
